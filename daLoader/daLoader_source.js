...
daLoader.class('daList', {path: _p+'/daList/daList_source.js', need:"da,daFx,daKey,daList_CSS" });				//列表 控件类
//-------------------------------------
...
daLoader.class('daTip', {path: _p+'/daTip/daTip_source.js', need:"da,daTip_CSS" });								//ToolTip类
