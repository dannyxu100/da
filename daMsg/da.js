	...
	da.extend({
		...
		*/
		out: function( msg, color ){
			...
			var outDiv = doc.getElementById("daDebugOutDiv"),
					lineObj;
			
			if( null === outDiv ){
				outDiv = doc.createElement("div");
				outDiv.id = "daDebugOutDiv";
				outDiv.style.cssText= "border-bottom: 1px solid #444; background:#fdff64;height:200px; overflow:scroll;";
				doc.body.insertBefore( outDiv, doc.body.firstChild );
			}
			
			if( da.isFunction( msg ) ){
